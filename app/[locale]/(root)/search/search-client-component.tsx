        ...
        <div className='flex items-center flex-wrap'>
          ...
          params.brand !== 'all') && (
            <div className="flex flex-wrap gap-1 sm:gap-2 ml-2 sm:ml-3 mt-2 md:mt-0">
              ...
              params.price !== 'all' ||
              params.brand !== 'all') && (
                <Button variant="outline" size="sm" asChild className="rounded-full border-primary/20 text-primary hover:bg-primary/10 hover:text-primary">
                  <Link href="./search?q=all&category=all&tag=all&price=all&rating=all&brand=all">Clear all filters</Link>
                </Button>
              )}
            </div>
          )}
